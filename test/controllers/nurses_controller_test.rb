...
class NursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nurse" do
    assert_difference("Nurse.count") do
      post nurses_url, params: { nurse: { contact_number: @nurse.contact_number, department: @nurse.department, name: @nurse.name } }
    end
  ...
  test "should update nurse" do
    patch nurse_url(@nurse), params: { nurse: { contact_number: @nurse.contact_number, department: @nurse.department, name: @nurse.name } }
